...
import com.example.myapplication.bussines.domain.state.MessageType
import com.example.myapplication.bussines.domain.state.Response
import com.example.myapplication.bussines.domain.state.StateMessage
import com.example.myapplication.bussines.domain.state.UIComponentType
